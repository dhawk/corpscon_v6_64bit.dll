...
typedef struct SP27_CONSTANTS *pSP27_CONSTANTS;
...
int Direct_AK1_27(pSP27_CONSTANTS sp27_c,
								double *lat_in, double *lon_in,
								double *north, double *east,
								double *conv, double *kp);
int Inverse_AK1_27(pSP27_CONSTANTS sp27_c,
								double *lat, double *lon,
								double *north_in, double *east_in,
								double *conv, double *kp);
int Direct_AK2thru9_27(pSP27_CONSTANTS sp27_c,
								double *lat_in, double *lon_in,
								double *north, double *east,
								double *conv, double *kp);
int Inverse_AK2thru9_27(pSP27_CONSTANTS sp27_c,
								double *lat, double *lon,
								double *north_in, double *east_in,
								double *conv, double *kp);
